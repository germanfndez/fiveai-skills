...
For data that needs to be fetched:
...
function requestFromUI(eventName, data, callback)
...
-- Usage
requestFromUI('getInventory', {}, function(inventory)
    print('Received inventory:', json.encode(inventory))
end)
```
